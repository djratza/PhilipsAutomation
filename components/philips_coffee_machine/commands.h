...
#define USE_DEFAULT_PHILIPS_COMMAND_SET
        ...
        const std::vector<uint8_t> command_pre_power_on =
            {0xD5, 0x55, 0x0A, 0x01, 0x02, 0x00, 0x09, 0x00, 0x00, 0x00, 0x09, 0x15};
	    ...
	    {0xD5, 0x55, 0x01, 0x01, 0x02, 0x00, 0x09, 0x00, 0x00, 0x00, 0x22, 0x20};
        ...
        const std::vector<uint8_t> command_press_play_pause =
            {0xD5, 0x55, 0x00, 0x01, 0x02, 0x00, 0x09, 0x00, 0x00, 0x01, 0x1E, 0x35};
        /// @brief EP3243: Press Coffee Button
        const std::vector<uint8_t> command_press_1 =
	    {0xD5, 0x55, 0x00, 0x01, 0x02, 0x00, 0x09, 0x08, 0x00, 0x00, 0x3E, 0x1B};
        /// @brief EP3243: Press Espresso Button
        const std::vector<uint8_t> command_press_2 =
	    {0xD5, 0x55, 0x00, 0x01, 0x02, 0x00, 0x09, 0x02, 0x00, 0x00, 0x0E, 0x2A};
